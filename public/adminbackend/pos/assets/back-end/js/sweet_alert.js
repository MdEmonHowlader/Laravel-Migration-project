!(function(e, t) {
    ...
    var t = "SweetAlert2:",
        ...
        se = function() {
            null === b.previousBodyPadding && document.body.scrollHeight > window.innerHeight && ((b.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"))), (document.body.style.paddingRight = b.previousBodyPadding +
                (function() {
        ...
        _main: function(e) {
            ...
            return new Promise(function(t, n) {
                ...
                if ("select" === M.input || "radio" === M.input) {
                    ...
                    -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(M.input) && D(M.inputValue) && (V.showLoading(), F(d), M.inputValue.then(function(e) {
