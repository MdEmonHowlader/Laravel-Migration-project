                ...
                e.on("select2:open", (function() {
                    if (s.leftOffset) {
                        ...
                        e.css({
                            ...
                            e.css({
                                left: parseInt(e.position().left) + s.leftOffset,
                                opacity: 1
                            })
                        }), 1)
                    }
        ...
        t.HSCore.components.HSValidation = {
            ...
            init: function(e, a) {
                if (e.length) {
                    ...
                    i = t.extend(!0, s, i, n, a), e.hasClass("js-step-form") ? t.validator.setDefaults({
                    ...
                    if ("line" === i.type && i.options.tooltips.lineMode) {
                        ...
                        o.draw = function(e) {
                            if (r.call(this, e), this.chart.tooltip._active && this.chart.tooltip._active.length) {
                                ...
                                t("#chartjsTooltip #chartjsTooltipLine").length || t("#chartjsTooltip").append('<div id="chartjsTooltipLine"></div>'), s.css({
                                    top: a.height() / 2 - s.height()
                                }), n.css({
                                    top: -(s.offset().top - a.offset().top) + o
                                }), s.offset().left + s.width() > a.offset().left + a.width() - 100 ? t(".hs-chartjs-tooltip").removeClass("hs-chartjs-tooltip-right").addClass("hs-chartjs-tooltip-left") : t(".hs-chartjs-tooltip").addClass("hs-chartjs-tooltip-right").removeClass("hs-chartjs-tooltip-left"), n.length && n.css({
                                    position: "absolute",
                                    width: "2px",
                                    height: a.height() - l,
                            ...
                            a.pageY - e.offset().top > t(".hs-chartjs-tooltip-wrap").height() / 2 && a.pageY - e.offset().top + t(".hs-chartjs-tooltip-wrap").outerHeight() / 2 < e.height() && t(".hs-chartjs-tooltip").css({
                                top: a.pageY + t(".hs-chartjs-tooltip-wrap").height() / 2 - (e.offset().top + e.height() / 2)
                            })
                        }))
                    }
                    return o
        ...
        t.HSCore.components.HSJVectorMap = {
            ...
            tipCentered: function(e) {
                t(".jvectormap-container").mousemove((function(t) {
                    ...
                    e.addClass("jvectormap-tip-cntered"), e.css({
                        top: a,
                        left: s
                    })
                }))
                        ...
                        o = {
                            beforeShow: function(e) {
                                var a = t(e.$refs.bg[0]),
                                    ...
                                    o = n.overlayBg,
                                    r = n.overlayBlurBg;
                                i && s.css("visibility", "hidden"), o && a.css({
                                    backgroundColor: o
                        ...
                        i = {
                            ...
                            onChange: function(e) {
                                ...
                                if (i.result_min_target_el && "single" === i.type ? t(i.result_min_target_el).is("input") ? t(i.result_min_target_el).val(e.from) : t(i.result_min_target_el).text(e.from) : (i.result_min_target_el || i.result_max_target_el && "double" === i.type) && (t(i.result_min_target_el).is("input") ? t(i.result_min_target_el).val(e.from) : t(i.result_min_target_el).text(e.from), t(i.result_min_target_el).is("input") ? t(i.result_max_target_el).val(e.to) : t(i.result_max_target_el).text(e.to)), i.grid && "single" === i.type && t(e.slider).find(".irs-grid-text").each((function(a) {
                                    ...
                                    for (var n = 0; n < i.secondary_val.steps.length; n++) e.from >= i.secondary_val.steps[n] && e.from < i.secondary_val.steps[n + 1] && (t(i.secondary_target_el).is("input") ? t(i.secondary_target_el).val(i.secondary_val.values[n]) : t(i.secondary_target_el).text(i.secondary_val.values[n]));
