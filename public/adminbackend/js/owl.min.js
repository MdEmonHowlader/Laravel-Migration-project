! function(t, e, i, s) {
    ...
    n.Defaults = {
        ...
        var i = this.current(),
            ...
            a = this.minimum(),
            h = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(n) > r / 2 && (n += -1 * o * r), (s = (((t = i + n) - a) % r + r) % r + a) !== t && s - n <= h && s - n > 0 && (i = s - n, t = s, this.reset(i))) : this.settings.rewind ? (h += 1, t = (t % h + h) % h) : t = Math.max(a, Math.min(h, t)), this.speed(this.duration(i, t, e)), this.current(t), this.$element.is(":visible") && this.update()
...
function(t, e, i, s) {
    ...
    var n = function(e) {
        ...
        }, this.owl.options = t.extend({}, n.Defaults, this.owl.options), this.owl.$element.on(this._handlers)
    };
    n.Defaults = {
        thumbs: !0,
        thumbImage: !1,
        ...
        e.thumbsPrerendered && (this._thumbcontent._thumbcontainer = t("." + e.thumbContainerClass)), t(this._thumbcontent._thumbcontainer).on("click", this._thumbcontent._thumbcontainer.children(), t.proxy(function(i) {
            this._identifier = t(i.target).closest("." + e.thumbContainerClass).data("slider-id");
            var s = t(i.target).parent().is(this._thumbcontent._thumbcontainer) ? t(i.target).index() : t(i.target).closest("." + e.thumbItemClass).index();
            e.thumbsPrerendered ? t("[data-slider-id=" + this._identifier + "]").trigger("to.owl.carousel", [s, e.dotsSpeed, !0]) : this.owl.to(s, e.dotsSpeed), i.preventDefault()
        }, this))
    }, n.prototype.render = function() {
        var e, i = this.owl.options;
        if (i.thumbsPrerendered ? (this._thumbcontent._thumbcontainer = t("." + i.thumbContainerClass), i.moveThumbsInside && this._thumbcontent._thumbcontainer.appendTo(this.$element)) : this._thumbcontent._thumbcontainer = t("<div>").addClass(i.thumbContainerClass).appendTo(this.$element), i.thumbImage)
            for (e = 0; e < this._thumbcontent.length; ++e) this._thumbcontent._thumbcontainer.append("<button class=" + i.thumbItemClass + '><img src="' + this._thumbcontent[e].attr("src") + '" alt="' + this._thumbcontent[e].attr("alt") + '" /></button>');
        else
        ...
        for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
    }, t.fn.owlCarousel.Constructor.Plugins.Thumbs = n
}(window.Zepto || window.jQuery, window, document);